...
void A(int16_t tic, int16_t tic_par_tour, int16_t offset){
    if(tic== (int) (offset)*(tic_par_tour/60)){ // la grande aiguille
        SPI_MasterTransmit_us(0x0FF0,10);
    }
    else if(tic==(int) (offset-1)*(tic_par_tour/60)){ // la grande aiguille
        SPI_MasterTransmit_us(0x0880,10);
    }
    else if(tic==(int) (offset-2)*(tic_par_tour/60)){ // la grande aiguille
        SPI_MasterTransmit_us(0x0880,10);
    }
    else if(tic==(int) (offset-3)*(tic_par_tour/60)){ // la grande aiguille
        SPI_MasterTransmit_us(0x0880,10);
    }
    else if(tic==(int) (offset-4)*(tic_par_tour/60)){ // la grande aiguille
        SPI_MasterTransmit_us(0x0FF0,10);
    }
}
